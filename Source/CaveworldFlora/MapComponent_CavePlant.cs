...
namespace CaveworldFlora
{
    ...
    public class MapComponent_ClusterPlant : MapComponent
    {
        ...
        {
            ThingDef_ClusterPlant cavePlantDef = CavePlantDefs.RandomElementByWeight((ThingDef_ClusterPlant plantDef) => plantDef.plant.wildClusterWeight / plantDef.clusterSizeRange.Average);
            
            int newDesiredClusterSize = cavePlantDef.clusterSizeRange.RandomInRange;
            IntVec3 spawnCell = IntVec3.Invalid;
            GenClusterPlantReproduction.TryGetRandomClusterSpawnCell(cavePlantDef, newDesiredClusterSize, true, map, out spawnCell);
